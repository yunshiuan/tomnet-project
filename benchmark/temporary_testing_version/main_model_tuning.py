...
if __name__ == "__main__":
    ...
    for times in range(1, 2, 1):
        ...
        DECAY_STEP_0 = 10000
        DECAY_STEP_1 = 15000
        ckpt_fname = 'training_result/caches/cache_S002a_v10_commit_0b68f9_epoch80000_tuning_batch96_train_step_2M_INIT_LR_10-5_' + str(times)
        train_fname = 'training_result/caches/cache_S002a_v10_commit_0b68f9_epoch80000_tuning_batch96_train_step_2M_INIT_LR_10-5_' + str(times)
        sub_dir='/../S002a/'
