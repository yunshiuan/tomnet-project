...
if(interactive()){
  ...
  PATH_RESULT_ROOT = file.path(getwd(),"..","..","..")
}else{
...
PATH_ROOT = str_extract(string = PATH_RESULT_ROOT,pattern = ".*tomnet-project")

#file
FILE_HELPER_FUNCTION = file.path(PATH_ROOT,"models","working_model",
